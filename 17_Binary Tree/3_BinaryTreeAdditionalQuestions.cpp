...
// static int idx = -1;
// Node *treecreation(vector<int> &nodes) // pass by reference to avoid copy
// {
//     idx++;
//     if (nodes[idx] == -1)
//     {
...
//     q.push(root);
//     q.push(NULL);
//     int count = 1; // Level counter starting from root as level 1
...
//         else
//         {
//             // If we are at the k-th level, print the node
//             if (count == k)
//                 cout << curr->data << " ";
...
//         }
//     }
//     cout << endl; // to move to new line after printing kth level
//     return 0;
// }
